...
A provider is the agent runtime that does the actual work. Crab supports several, and the
...
| `crab`        | [`Drivers/CrabDriver.ts`][crab]         |
...
[crab]: ../../apps/server/src/provider/Drivers/CrabDriver.ts
