...
T3CODE_PORT=13773 \
  "/Applications/Crab (Alpha).app/Contents/MacOS/Crab (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Crab (Alpha).app"
codesign -d --entitlements :- "/Applications/Crab (Alpha).app"
```
