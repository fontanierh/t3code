...
deployment provides these stable paths:

```text
ACP channel facade: ~/.crab-v2/bin/crab-v2-acp-channel
Runtime state:      ~/.crab-v2/state
```
...
```text
Binary path:    ~/.crab-v2/bin/crab-v2-acp-channel
State directory: ~/.crab-v2/state
