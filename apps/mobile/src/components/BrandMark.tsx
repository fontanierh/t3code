...
const BRAND_MARK_SOURCE =
  appVariant === "development"
    ? require("../../../../assets/dev/crab-dev-ios-1024.png")
    : appVariant === "preview"
      ? require("../../../../assets/nightly/crab-nightly-ios-1024.png")
      : require("../../../../assets/prod/crab-ios-1024.png");
    ...
    <View className="flex-row items-center gap-3">
      ...
      <View className="gap-1">
        <View className="flex-row items-center gap-2">
          <Text className="text-lg font-t3-bold tracking-[-0.4px] text-foreground">Crab</Text>
