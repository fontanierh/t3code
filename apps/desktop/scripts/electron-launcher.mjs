// This file mostly exists because we want dev mode to say "Crab (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Crab (Dev)" : "Crab (Alpha)";
...
const developmentMacIconPngPath = NodePath.join(
  ...
  "assets",
  "dev",
  "crab-dev-macos-1024.png",
);
const productionMacIconPngPath = NodePath.join(repoRoot, "assets", "prod", "crab-macos-1024.png");
...
function buildMacLauncher(electronBinaryPath) {
  ...
  if (isDevelopment) {
    ...
    // Electron.app even though this bundle's Info.plist has the Crab name.
