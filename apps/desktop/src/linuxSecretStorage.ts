...
function getGnomeKeyringRemediationMessage(): string {
  return "Crab could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Crab.";
}

function getKWalletRemediationMessage(): string {
  return "Crab could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Crab.";
}
