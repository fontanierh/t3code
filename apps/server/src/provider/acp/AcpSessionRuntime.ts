...
export interface AcpSessionRuntimeOptions {
  ...
  /**
   * Standard ACP agents generally accept one prompt at a time. Harnesses that
   * implement real-time steering may opt into overlapping prompt RPCs.
   */
  readonly promptConcurrency?: "serialize" | "concurrent";
      ...
      cancel: getStartedState.pipe(
        Effect.flatMap((started) =>
          Effect.gen(function* () {
            ...
            yield* Effect.forEach(activePromptFibers, (fiber) => Fiber.interrupt(fiber), {
