  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Crab prerelease is available for nightly testers."
          : "A new Crab latest release is available.",
...
).pipe(Command.withDescription("Post a Crab release announcement to Discord."));
