...
/**
 * Per-message delivery while provider work may already be active.
 * Omission preserves each provider's existing automatic behavior.
 */
export const ProviderTurnDeliveryMode = Schema.Literals(["queue", "steer"]);
